  ...
  return (
    <Card className="h-full">
      <CardHeader className="pb-2 border-b border-brand-gray/20 mb-4 flex flex-row items-center justify-between">
        <CardTitle className="text-lg font-display font-semibold text-brand-navy">Recent Activity</CardTitle>
  ...
  return (
    <Card className="h-full">
      <CardHeader className="pb-2 border-b border-brand-gray/20 mb-4">
        <CardTitle className="text-lg font-display font-semibold text-brand-navy">Activity Summary</CardTitle>
      </CardHeader>
      <CardContent>
