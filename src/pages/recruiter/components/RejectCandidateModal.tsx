...
export function RejectCandidateModal({ isOpen, onClose, onConfirm, candidateName }: RejectCandidateModalProps) {
          ...
          >
            <div className="p-6">
              ...
              <p className="text-brand-navy/70 text-sm">
                Are you sure you want to reject <span className="font-semibold text-brand-navy">{candidateName || "this candidate"}</span>? This will update their application status and remove them from active consideration.
              </p>
            </div>
